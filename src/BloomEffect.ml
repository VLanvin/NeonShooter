...
let blur_shader = new shader 
  ~vertex:(ShaderSource.file "shaders/bloom.vert")
  ~fragment:(ShaderSource.file "shaders/blur.frag") ()

let filter_shader = new shader
  ~vertex:(ShaderSource.file "shaders/bloom.vert")
  ~fragment:(ShaderSource.file "shaders/filter.frag") ()

let add_shader = new shader
  ~vertex:(ShaderSource.file "shaders/bloom.vert")
  ~fragment:(ShaderSource.file "shaders/add.frag") ()
